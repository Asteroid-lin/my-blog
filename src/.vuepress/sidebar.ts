  ...
  "/business-system/supply-chain/oms/": [
    {
      ...
      collapsible: false,
      children: [
        { text: "基础认知", collapsible: false, children: ["", "design-thinking"] },
        {
          text: "主数据与基础资料",
          collapsible: false,
          children: ["master-data", "product-center", "customer-channel"],
        },
        ...
        { text: "售后领域", collapsible: false, children: ["after-sales"] },
        { text: "财务与结算", collapsible: false, children: ["finance-settlement"] },
